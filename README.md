...
- A **manifest document**, describing those sources files, including their:
...
- A collection of **data files** in CSV format containing the F2 through F5 data you extracted from the corpus. These files should include, at a minimum, the following core tables:
...
DS 5001
[DATE in /DD MonthName YY/ format]
```
